...
function imageSlider(){
	...
	var length = imageBox.childElementCount;

	setInterval(function() {
		index = index + 1;
		index = index % length;
		imageBox.style.transform = "translate(-"+ (width * index) + "px,0)";
	}, 2000)
}
...
function addNewItem() {
	...
	var currentItemCount = document.querySelectorAll('.event .wrap_event_box .lst_event_box .item').length;
